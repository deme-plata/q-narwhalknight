...
pub enum NetworkMessage {
    ...
    Consensus {
        __consensus_type: ConsensusType,
        data: Vec<u8>,
         _ ___timestamp: u64,
    },
    ComputeTask {
         _ ___contract: Bytes32,
        model: String,
        input: Vec<u8>,
         _ ___timestamp: u64,
    },
    ComputeResult {
        ...
        output: Vec<u8>,
         _ ___proof: Bytes64,
         _ ___resources: ResourceUsage,
         _ ___timestamp: u64,
    },
    NodeStatus {
         _ ___node_id: Bytes32,
         _ ___status: NodeStatus,
         _ ___available_resources: AvailableResources,
         _ ___timestamp: u64,
    },
    ModelRegistry {
         _ ___action: ModelRegistryAction,
        data: Vec<u8>,
         _ ___timestamp: u64,
    },
}
...
impl P2PMessageHandler {
    ...
    async fn handle_transaction(async fn handle_transaction(async fn handle_transaction(&self, data: Vec<u8>, __hash: Bytes32, __timestamp: u64)self, data: Vec<u8>, ___hash: Bytes32, ___timestamp: u64)self, data: Vec<u8>, ___hash: Bytes32, ___timestamp: u64) -> Result<(), MessageError> {
        if data.is_empty() {
    ...
    async fn handle_block(async fn handle_block(async fn handle_block(&self, data: Vec<u8>, __hash: Bytes32, __height: u64, __timestamp: u64)self, data: Vec<u8>, ___hash: Bytes32, ___height: u64, ___timestamp: u64)self, data: Vec<u8>, ___hash: Bytes32, ___height: u64, ___timestamp: u64) -> Result<(), MessageError> {
        if data.is_empty() {
    ...
    async fn handle_consensus(async fn handle_consensus(async fn handle_consensus(&self, __consensus_type: ConsensusType, data: Vec<u8>, __timestamp: u64)self, ___consensus_type: ConsensusType, data: Vec<u8>, ___timestamp: u64)self, ___consensus_type: ConsensusType, data: Vec<u8>, ___timestamp: u64) -> Result<(), MessageError> {
        if data.is_empty() {
