...
pub enum NetworkMessage {
    ...
    ComputeResult {
        ...
        output: Vec<u8>,
         _ __proof: Bytes64,
         _ __resources: ResourceUsage,
         _ __timestamp: u64,
    },
    NodeStatus {
         _ __node_id: Bytes32,
         _ __status: NodeStatus,
         _ __available_resources: AvailableResources,
         _ __timestamp: u64,
    },
    ModelRegistry {
         _ __action: ModelRegistryAction,
        data: Vec<u8>,
         _ __timestamp: u64,
    },
}
...
impl P2PMessageHandler {
    ...
    async fn handle_transaction(async fn handle_transaction(async fn handle_transaction(&self, data: Vec<u8>, _hash: Bytes32, _timestamp: u64)self, data: Vec<u8>, __hash: Bytes32, __timestamp: u64)self, data: Vec<u8>, __hash: Bytes32, __timestamp: u64) -> Result<(), MessageError> {
        if data.is_empty() {
    ...
    async fn handle_block(async fn handle_block(async fn handle_block(&self, data: Vec<u8>, _hash: Bytes32, _height: u64, _timestamp: u64)self, data: Vec<u8>, __hash: Bytes32, __height: u64, __timestamp: u64)self, data: Vec<u8>, __hash: Bytes32, __height: u64, __timestamp: u64) -> Result<(), MessageError> {
        if data.is_empty() {
    ...
    async fn handle_consensus(async fn handle_consensus(async fn handle_consensus(&self, _consensus_type: ConsensusType, data: Vec<u8>, _timestamp: u64)self, __consensus_type: ConsensusType, data: Vec<u8>, __timestamp: u64)self, __consensus_type: ConsensusType, data: Vec<u8>, __timestamp: u64) -> Result<(), MessageError> {
        if data.is_empty() {
