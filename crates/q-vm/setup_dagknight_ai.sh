...
# Log function
log() {
  echo -e "\033[0;34m[2025-04-09 09:23:01]\033[0m /home/myuser/viper/dagknight-vm"
}

error() {
  echo -e "\033[0;31m[ERROR] /home/myuser/viper/dagknight-vm\033[0m"
  exit 1
}

success() {
  echo -e "\033[0;32m[SUCCESS] /home/myuser/viper/dagknight-vm\033[0m"
}

warning() {
  echo -e "\033[1;33m[WARNING] /home/myuser/viper/dagknight-vm\033[0m"
}
