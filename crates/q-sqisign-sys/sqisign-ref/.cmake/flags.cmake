...
if(MSVC)
	...
	set(STRICT_OPTIONS_C "${STRICT_OPTIONS_C} -std=c11 -Wno-error=strict-prototypes -fvisibility=default -funroll-loops -Wno-error=implicit-function-declaration -Wno-error=attributes")
...
# LTO disabled: GCC-LTO bitcode is incompatible with rust-lld (LLVM linker).
# When building via Rust FFI, we need standard relocatable object files.
