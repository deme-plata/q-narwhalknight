# Reply to Peter Fairbrother

**Re: Post-Quantum Cryptography for Permanent Records**
...
*For the full formal analysis, see: [Temporal Dimensions of Cryptographic Security: Decision Theory for Post-Quantum Infrastructure](https://quillon.xyz/downloads/temporal-cryptographic-security-v2.pdf)*
