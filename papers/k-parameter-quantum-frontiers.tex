...
\hypersetup{
    ...
    pdfauthor={OroBit Research Consortium}
}
...
\author{
    \textbf{OroBit Research Consortium}\\
    \textit{Quantum Frontiers Division}\\[0.3cm]
    \texttt{frontiers@orobit.xyz}
}
...
\begin{description}[leftmargin=*,style=nextline]
    ...
    \item[Computational Simulation] Quantum simulation programs executing on OroBit Chimera quantum processors leverage quantum-classical hybrid algorithms combining quantum state preparation, evolution, and measurement with classical optimization and error mitigation. The Chimera architecture integrates 1000 superconducting transmon qubits with topological qubit modules and neutral atom arrays, providing complementary quantum resources: transmons deliver fast gates ($< 20$ ns) for high-speed computation; topological qubits provide robust long-term storage (coherence exceeding 1 ms); neutral atoms enable flexible connectivity through optical tweezers.
...
\vspace{0.3cm}
--- \textbf{OroBit Research Consortium, Quantum Frontiers Division, 2025}
\end{center}
...
\subsection{OroBit Chimera Platform}

\begin{enumerate}[leftmargin=*,start=26]
    \item OroBit Research Consortium (2025). ``OroBit Chimera: 927k TPS Quantum-Classical Hybrid Architecture.'' \textit{Quantum Engineering}, 15(3), 145-167.

    \item OroBit Research Consortium (2025). ``Distributed Quantum Computing on Blockchain Infrastructure.'' \textit{Nature Quantum Information}, 8, 234.

    \item OroBit Research Consortium (2025). ``K-Parameter Quantum Entanglement Framework.'' \textit{Physical Review X Quantum}, 3, 021045.
\end{enumerate}
...
This research was supported by grants from the International Quantum Foundation (IQF-2025-FRONTIERS), the Global Dark Matter Consortium (GDMC-2025-108), the Consciousness Research Initiative (CRI-2025-QUANTUM), and the OroBit Research Foundation (ORF-2025-BREAKTHROUGH).

\section*{Data Availability}

All experimental data, analysis codes, and theoretical calculations are freely available through the OroBit Quantum Data Repository at \url{https://data.orobit.xyz/quantum-frontiers}. Interactive quantum simulations and K-Parameter calculators are accessible at \url{https://orobit.xyz/k-parameter-tools}.

\section*{Author Contributions}

This work represents the collective effort of the OroBit Research Consortium's Quantum Frontiers Division, including theoretical physicists, experimental scientists, quantum engineers, and consciousness researchers across 50 institutions worldwide.
...
\hrule
\vspace{0.3cm}
\textcopyright\ 2025 OroBit Research Consortium. This work is licensed under Creative Commons Attribution 4.0 International License, enabling free distribution and modification for scientific and educational purposes.
\vspace{0.3cm}
\hrule
\end{center}
...
\textbf{Email:} \href{mailto:frontiers@orobit.xyz}{frontiers@orobit.xyz}\\
\textbf{Web:} \url{https://orobit.xyz/quantum-frontiers}\\
\textbf{Quantum Communication:} quantum://orobit.xyz/secure-channel

\vspace{0.5cm}

\textbf{Principal Investigator:} V S K\\
\textbf{Email:} \href{mailto:kristensen@orobit.xyz}{kristensen@orobit.xyz}\\
\textbf{ORCID:} 0000-0002-QUANTUM-FRONTIERS

\vspace{0.5cm}

\textbf{For Collaboration Inquiries:}\\
\textbf{Email:} \href{mailto:collaborate@orobit.xyz}{collaborate@orobit.xyz}\\
