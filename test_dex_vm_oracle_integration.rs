...
//! Q-NarwhalKnight DEX, VM, and Oracle Integration Test
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    match test_quantum_dex().await {
        Ok(metrics) => {
            ...
            test_results.push(("DEX", true, metrics.test_duration));
        }
        Err(e) => {
            println!("   ❌ DEX tests failed: {}", e);
            test_results.push(("DEX", false, Duration::from_secs(0)));
        }
    }
    println!();
    ...
    println!("───────────────────────────────────────────");
    match test_dag_knight_vm().await {
        Ok(metrics) => {
            ...
            test_results.push(("VM", true, metrics.test_duration));
        }
        Err(e) => {
            println!("   ❌ VM tests failed: {}", e);
            test_results.push(("VM", false, Duration::from_secs(0)));
        }
    }
    println!();
    ...
    println!("────────────────────────────────────────");
    match test_quantum_oracle().await {
        Ok(metrics) => {
            ...
            test_results.push(("Oracle", true, metrics.test_duration));
        }
        Err(e) => {
            println!("   ❌ Oracle tests failed: {}", e);
            test_results.push(("Oracle", false, Duration::from_secs(0)));
        }
    }
    println!();
    ...
    println!("───────────────────────────────────────");
    match test_full_integration().await {
        Ok(metrics) => {
            ...
            test_results.push(("Integration", true, metrics.test_duration));
        }
        Err(e) => {
            println!("   ❌ Integration tests failed: {}", e);
            test_results.push(("Integration", false, Duration::from_secs(0)));
        }
    }
    println!();
    ...
    println!("─────────────────────────────────────────");
    match benchmark_full_system().await {
        Ok(metrics) => {
            ...
            test_results.push(("Benchmark", true, metrics.test_duration));
        }
        Err(e) => {
            println!("   ❌ Benchmark failed: {}", e);
            test_results.push(("Benchmark", false, Duration::from_secs(0)));
        }
    }
    println!();
...
async fn test_quantum_dex() -> Result<DexTestMetrics, Box<dyn std::error::Error>> {
...
async fn test_dag_knight_vm() -> Result<VmTestMetrics, Box<dyn std::error::Error>> {
    let start_time = Instant::now();
...
async fn test_quantum_oracle() -> Result<OracleTestMetrics, Box<dyn std::error::Error>> {
    let start_time = Instant::now();
...
async fn test_full_integration() -> Result<IntegrationTestMetrics, Box<dyn std::error::Error>> {
    let start_time = Instant::now();
...
async fn benchmark_full_system() -> Result<BenchmarkMetrics, Box<dyn std::error::Error>> {
    let start_time = Instant::now();
