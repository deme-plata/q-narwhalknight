#!/bin/bash
# Quillon Graph — Claude Code AI Setup
# Run: curl -fsSL https://quillon.xyz/setup-claude.sh | bash
#
# This script sets up Claude Code to manage your Quillon wallet and mining
# using natural language. After setup, just say:
#   "Create a wallet"
#   "Start mining"
#   "What's my balance?"
set -e
...
if ! command -v claude &>/dev/null; then
  ...
  echo ""
  echo "  Then re-run: curl -fsSL https://quillon.xyz/setup-claude.sh | bash"
  exit 1
fi
