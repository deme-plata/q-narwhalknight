...
export default function MiningScreen() {
  ...
  const miningCommand = `./q-miner-linux-x64 --mode solo --wallet ${walletAddress} --threads 4 --intensity 7 --server ${currentServerUrl}`;
          ...
          >
            ...
            <div className="bg-quantum-indigo/30 backdrop-blur-xl border border-quantum-green/30 rounded-xl p-6">
              ...
              <h3 className="text-lg font-bold text-white mb-2 flex items-center gap-2">
                ...
                Miner Downloads
                <span className="text-xs font-medium px-2 py-0.5 bg-quantum-green/20 text-quantum-green rounded-full">v10.9.54</span>
              </h3>
