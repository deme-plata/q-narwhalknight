...
export default function MiningScreen() {
  ...
  const miningCommand = `./q-miner-v10.3.8 --mode solo --wallet ${walletAddress} --threads 4 --intensity 7 --server ${currentServerUrl}`;
                  ...
                  <div className="grid md:grid-cols-2 gap-3">
                    ...
                    <div className="bg-quantum-dark/50 rounded-lg p-4 border border-quantum-cyan/20 relative">
                      ...
                      <div className="space-y-1 font-mono text-xs text-gray-300 overflow-x-auto">
                        <code className="block">wget https://quillon.xyz/downloads/q-miner-v10.3.8</code>
                        <code className="block">chmod +x q-miner-v10.3.8</code>
                        <code className="block text-quantum-green mt-2">./q-miner-v10.3.8 --mode solo \</code>
                      ...
                      <button
                        onClick={() => copyCommand(`wget https://quillon.xyz/downloads/q-miner-v10.3.8 && chmod +x q-miner-v10.3.8 && ./q-miner-v10.3.8 --mode solo --wallet ${walletAddress || 'YOUR_WALLET'} --server ${currentServerUrl}`)}
          ...
          >
            ...
            <div className="bg-quantum-indigo/30 backdrop-blur-xl border border-quantum-green/30 rounded-xl p-6">
              ...
              <h3 className="text-lg font-bold text-white mb-2 flex items-center gap-2">
                ...
                Miner Downloads
                <span className="text-xs font-medium px-2 py-0.5 bg-quantum-green/20 text-quantum-green rounded-full">v10.3.8</span>
              </h3>
              ...
              <div className="bg-quantum-dark/50 rounded-lg p-4 border border-quantum-cyan/20 mb-6">
                ...
                <div className="space-y-2">
                  <div className="bg-quantum-dark/80 rounded-lg p-2 font-mono text-xs text-gray-300 flex items-center justify-between">
                    <code>wget https://quillon.xyz/downloads/q-miner-v10.3.8 && chmod +x q-miner-v10.3.8</code>
                    <button onClick={() => copyCommand('wget https://quillon.xyz/downloads/q-miner-v10.3.8 && chmod +x q-miner-v10.3.8')} className="text-quantum-cyan hover:text-white ml-2 flex-shrink-0 text-xs px-2">Copy</button>
                  </div>
                  <div className="bg-quantum-dark/80 rounded-lg p-2 font-mono text-xs text-gray-300 flex items-center justify-between">
