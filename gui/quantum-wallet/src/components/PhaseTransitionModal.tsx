            ...
            <>
                  ...
                  <table style={{width: '100%', borderCollapse: 'collapse', marginTop: '10px'}}>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style={{textAlign: 'right', padding: '8px'}}>2,625,000 QUG/year</td>
                        <td style={{textAlign: 'right', padding: '8px', color: '#51cf66', fontWeight: 'bold'}}>2,625,000 QUG/year (same)</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div className="detail-section highlight">
                ...
                <ul className="bullet-list">
                  <li>📥 <strong>Download v10.1.1</strong> — Latest binary with gap-aware sync + mining load balancing</li>
                  ...
                  <li>⛏️ <strong>Same emission model</strong> — 2,625,000 QUG/year (Era 0), 21M max supply, 4-year halving</li>
                </ul>
              </div>

              {/* Download Section */}
              <div className="action-section">
                <h3>📥 Download v10.1.1</h3>
                <p>Download the latest binary:</p>
                <div className="download-links">
                  <a href="https://quillon.xyz/downloads/q-api-server-v10.1.1" className="download-btn" download style={{marginRight: '10px'}}>
                    📦 Node v10.1.1
                  </a>
                  <a href="https://quillon.xyz/downloads/q-miner-v10.1.1" className="download-btn" download>
                    ⛏️ Miner v10.1.1
                  </a>
                </div>
                <div className="code-block">
                  <code>
                    ...
                    # Download v10.1.1<br/>
                    wget https://quillon.xyz/downloads/q-api-server-v10.1.1<br/>
                    wget https://quillon.xyz/downloads/q-miner-v10.1.1<br/>
                    chmod +x q-api-server-v10.1.1 q-miner-v10.1.1<br/><br/>
                    # Start node<br/>
                    ./q-api-server-v10.1.1 --port 8080<br/><br/>
                    # Start mining<br/>
                    ./q-miner-v10.1.1 --mode solo --wallet YOUR_WALLET --threads 4
                  </code>
                </div>
              </div>
                ...
                <div className="bootstrap-info">
                  ...
                  <div className="code-block">
                    <code>
                      ...
                      Max Supply: 21,000,000 QUG<br/><br/>
                      // Gossipsub Topics<br/>
            ...
            <div className="faq-section">
              ...
              <div className="faq-item">
                ...
                <p>
                  ...
                  (2,625,000 QUG/year, 21M max supply), better isolation.
                </p>
              </div>
              ...
              <div className="faq-item">
                ...
                <p>
                  A: Yes. Same 21M max supply, same 2,625,000 QUG/year target, same 4-year halving cycle.
