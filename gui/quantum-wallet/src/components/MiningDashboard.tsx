...
export default function MiningDashboard() {
  ...
  const handleMiningReward = (reward: MiningRewardEvent) => {
    ...
    // Track latest reward (used elsewhere); green popup toast removed 2026-07-03
  ...
  return (
    <div className="space-y-6">
      {/* Reward Popup removed 2026-07-03 — the recurring green "Mining Reward!" toast was noise. */}
